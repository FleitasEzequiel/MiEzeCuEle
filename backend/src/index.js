...
const cookieHelper_js_1 = require("./helpers/cookieHelper.js");
const dbMapper_js_1 = require("./helpers/dbMapper.js");
...
App.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let info = { database: "", dbs: [] };
    if (req.body.session == "logout") {
        res.clearCookie("user");
    }
    try {
        const resp = yield (0, db_js_1.default)(cookie ? cookie : req.body);
        const data = yield resp.query(`SELECT TABLE_NAME,TABLE_SCHEMA FROM INFORMATION_SCHEMA.TABLES`);
        const dbs = yield resp.query(`SHOW DATABASES`);
